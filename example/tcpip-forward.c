...
const char *keyfile1 = "/home/dns/.ssh/id_rsa.pub";
const char *keyfile2 = "/home/dns/.ssh/id_rsa";
const char *username = "root";
const char *password = "2y8uLenYZE";

const char *server_ip = "45.62.238.110";

const char *remote_listenhost = "localhost"; /* resolved by the remote server */
int remote_wantport = 9901;
